...
//   row, rowIndex, columns, isSelected, isChecked, showDefaultSelectionColumn, onRowClick, onToggleRow, currentRows 
// }) => {
...
//     prevProps.showDefaultSelectionColumn === nextProps.showDefaultSelectionColumn &&
//     prevProps.currentRows === nextProps.currentRows
//   );
// });
...
//   // FIX: Filter columns here once to use everywhere in the render
...
//     // Use visibleColumns to check for active selection logic
...
//         <div 
//           className={`flex flex-col bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden min-w-0 ${!renderDetailPanel ? 'w-full' : 'w-4/5'}`}
//           style={{ height: height }}
//         >
...
//                     </th>
//                   )}
//                   {/* FIX: Use visibleColumns instead of columns */}
...
//                       row={row}
//                       rowIndex={rowIndex}
//                       columns={visibleColumns} // FIX: Pass filtered columns to the row
    ...
    <>
      ...
      <div className="flex w-full p-2 gap-4 overflow-hidden h-full">
        <div 
          ...
          style={{ 
             height: height,
             // If panel is active, subtract width from 100%, otherwise 100%
        ...
        {renderDetailPanel && (
          <div 
            className="bg-white rounded-md shadow-sm border border-gray-200 p-3 overflow-y-scroll custom-scrollbar transition-all duration-300"
            style={{ 
              height: height, 
              width: detailPanelWidth, // Applied dynamic width here
              overflowY: 'auto', 
              scrollbarWidth: 'thin', 
              scrollbarColor: '#cbd5e1 #f1f5f9' 
            }}
