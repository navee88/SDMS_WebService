...
const EditTask = () => {
    ...
    const handleEditClick = useCallback(() => {
        ...
        navigate(`/scheduler/edit/${selectedScheduler.L13ScheduleID}`);
    }, [selectedScheduler, navigate, showInfoDialog, t]);
    ...
    const handleExportClick = useCallback(async () => {
        ...
        try {
            // Implement export logic based on jQuery's EditScheduler_export function
            const exportData = {
                sFileName: "EditScheduler",
                AllRows: schedulerData,
                HeaderDetails: [
                    t('scheduler.taskID'),
                ...
                AllowKeys: [
                    "L13ScheduleID", "L06ClientName", "L09FTPAliasName", "L13LiveArchive", 
                    "L13TaskName", "L11InstrumentAliasName", "L13SourcePath", "L52TaskCompleted",
                    "EmpowerStatus", "L13UNCStatus", "TaskStatus", "ClientStatus", "InstrumentStatus",
                    "StartDate", "EndDate", "TriggerTime", "ScheduleMode", "NextScheduleDate",
                    "LastScheduleDateTime", "CreatedBy", "CreatedDate", "ModifiedBy", "ModifiedDate"
                ]
            };
    ...
    const columns = useMemo(() => [
        ...
        {
            key: 'L09FTPAliasName',
            label: t('scheduler.ftpaliasname'),
            width: 150,
            render: (row, isSelected) => (
                <div style={{ 
                    fontSize: '12px', 
